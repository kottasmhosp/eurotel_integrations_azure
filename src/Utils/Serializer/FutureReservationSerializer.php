...
class FutureReservationSerializer extends BaseSerializer
{
    ...
    {
        /** @var FutureReservation $data */
        if (get_class($data) == FutureReservation::class) {
            return [
    ...
    {
        if ($type === FutureReservation::class) {
            $data['status'] = $this->getStatus($data['RESV_STATUS']);
        }
