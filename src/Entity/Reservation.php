...
#[ORM\Index(name: 'idx_reservation_id_2', fields: ['reservationId'])]
class Reservation
{
    /**
     * @ORM\Id()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\HotelGroup", inversedBy="reservations")
     * @ORM\JoinColumn(nullable=false)
     */
    #[ORM\ManyToOne(targetEntity: HotelGroup::class, inversedBy: "reservations")]
    #[ORM\JoinColumn(nullable: false)]
